...
combinacion(3, 6)
print("Combinaciones con itertools cuando n=6 y r=3:")
import itertools
...
combinacion(2, 6)
print("Combinaciones con itertools cuando n=6 y r=2:")
import itertools
...
combinacion(5, 7)
print("Combinaciones con itertools cuando n=7 y r=5:")
import itertools
